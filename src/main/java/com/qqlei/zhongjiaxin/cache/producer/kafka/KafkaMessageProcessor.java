...
public class KafkaMessageProcessor implements Runnable {
	...
	public void run() {
        ...
        while (it.hasNext()) {
        	...
        	System.out.println("=====================kafka消费消息："+message+"========================");
        	// 首先将message转换成json对象
	...
	private void processProductInfoChangeMessage(JSONObject messageJSONObject) {
		...
		String productInfoJSON = "{\"id\": 8, \"name\": \"iphone7手机\", \"price\": 5599, \"pictureList\":\"a.jpg,b.jpg\", \"specification\": \"iphone7的规格\", \"service\": \"iphone7的售后服务\", \"color\": \"红色,白色,黑色\", \"size\": \"5.5\", \"shopId\": 1, \"modifiedTime\": \"2017-01-01 12:00:00\"}";
